...
| # | 问题 | 状态 | 上下文 |
|---|------|------|--------|
| D1 | ai-agent-memory.md 是否按新标准重写 | 待决定 | 当前为英文文章摘要风格，与 rag.md 新标准不一致 |
| D2 | AI Domain 知识语言策略 | 待决定 | rag.md 已切换为中文为主，ai-agent-memory.md 仍为英文。是否统一？ |

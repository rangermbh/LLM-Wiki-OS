...
| 2026-08-06 | ingest | Routed "博士生科研入门辅导（骆昱宇，HKUST(GZ)）" → wiki/references/luo-phd-research-methodology.md. Domain: AI. Type: reference (talk). Primary intent: research methodology guide for CS/AI graduate students. AI Domain 首个 Reference 页面。Capture 含 OCR 补充层（48/70 页，57.7% 平均置信度，+39,152 字符）。Reference 页面明确标注了 Text Layer / OCR Layer 来源区分和置信度等级。 |
